...
const bfsPaths = BFS(graph, vertex5, vertex25);
console.log({bfsPaths});

const dfsPaths = DFS(graph, vertex5, vertex25);
console.log({dfsPaths});

const dijkstraPaths = Dijkstra(graph, vertex5, vertex25);
console.log({dijkstraPaths});
